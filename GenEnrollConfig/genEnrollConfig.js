...
var cmd_get_uid = utils.format("powershell ./OpenSSL/bin/openssl x509 -noout -subject -in %s -config ./OpenSSL/bin/openssl.cnf",apnscerPath);
...
var cmd_sign_mobileconfig  = utils.format("powershell ./OpenSSL/bin/openssl smime -sign -in %s -out %s -signer %s -inkey %s -certfile %s -outform der -nodetach -config ./OpenSSL/bin/openssl.cnf",enrollmobileconfigPath,signedenrollmobileconfigPath,serverCrtPath,serverKeyPath,caCrtPath);
